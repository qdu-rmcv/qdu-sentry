...
#ifndef PB_NAV2_PLUGINS__LAYERS__INTENSITY_OBSTACLE_LAYER_HPP_
#define PB_NAV2_PLUGINS__LAYERS__INTENSITY_OBSTACLE_LAYER_HPP_
...
/**
 * @class IntensityObstacleLayer
 * @brief Takes in laser and pointcloud data to populate into 2D costmap
 */
class IntensityObstacleLayer : public nav2_costmap_2d::CostmapLayer
{
public:
  /**
   * @brief A constructor
   */
  IntensityObstacleLayer()
  {
   ...
   * @brief A destructor
   */
  virtual ~IntensityObstacleLayer();
  /**
...
protected:
  ...
  double min_obstacle_intensity_;  ///< @brief Min Obstacle Intensity
  double max_obstacle_intensity_;  ///< @brief Max Obstacle Intensity
...
#endif  // PB_NAV2_PLUGINS__LAYERS__INTENSITY_OBSTACLE_LAYER_HPP_
