...
def generate_launch_description():
    ...
    segmentation_params = os.path.join(rm_nav_bringup_dir, 'config', 'segmentation.yaml')
    ########################## linefit_ground_segementation parameters end ############################

    #################################### FAST_LIO parameters start ####################################
    fastlio_mid360_params = os.path.join(rm_nav_bringup_dir, 'config', 'fastlio_mid360.yaml')
    fastlio_rviz_cfg_dir = os.path.join(rm_nav_bringup_dir, 'rviz', 'fastlio.rviz')
    ##################################### FAST_LIO parameters end #####################################

    ################################### POINT_LIO parameters start ####################################
    pointlio_mid360_params = os.path.join(rm_nav_bringup_dir, 'config', 'pointlio_mid360.yaml')
    ...
    slam_toolbox_localization_file_dir = os.path.join(rm_nav_bringup_dir, 'config',  'mapper_params_localization.yaml')
    slam_toolbox_mapping_file_dir = os.path.join(rm_nav_bringup_dir, 'config',  'mapper_params_online_async.yaml')
    ...
    nav2_params_file_dir = os.path.join(rm_nav_bringup_dir, 'config', 'nav2_params.yaml')
    ...
    pointcloud_downsampling_config_dir = os.path.join(rm_nav_bringup_dir, 'config', 'pointcloud_downsampling.yaml')
    ############################# pointcloud_downsampling parameters start ############################
    ...
    bringup_terrain_analysis_node = Node(
    ...
    ld.add_action(bringup_terrain_analysis_node)
